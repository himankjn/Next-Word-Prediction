...
**NOTE:** Since the outputs from tokenizationandcleaning.R and ngram.R files are relatively big, they do not exist in this repository. You will have to run the code from both files to generate following R objects which are required for final prediction.
